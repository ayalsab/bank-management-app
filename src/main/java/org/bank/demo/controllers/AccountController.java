...
public class CurrencyController {
    ...
    public Currency addStudent(@RequestBody Currency currency) throws CurrencyAlreadyExistException, IdNumberNotValidException, InvalidCurrencyDataException{
        try {
            return this.currencyBL.addCurrency(currency);
        } catch (Exception e) {
